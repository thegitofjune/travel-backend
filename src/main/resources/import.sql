...
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Belize',  'Belize has some amazing sport for snorkelling and diving, the seafood is amazing too', 5);
...
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Guatemala',  'Great for the Inka trail and some beautiful nature', 5);
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Argentina',  'Such a huge country and I only got to see a little, the people are great and you can learn to tango. Bit heavy on the meat diet though', 5);
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Peru',  'Lima is great for dance and good, then there''s Macchu Picchu of course, well worth the effort', 5);
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Chile',  'Only got to see the capital here, which is great, lots of dancing, return visit needed, ', 5);
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Easter Island',  'A Once in a lifetime trip, takes a fair bit of effort to get here but this unique place and the Rapa Nui are well worth the effort', 5);
insert into location (locationId, name, review, rating ) values (nextval('location_seq'), 'Uruguay',  'A small country, more stable than most in south america', 3);
